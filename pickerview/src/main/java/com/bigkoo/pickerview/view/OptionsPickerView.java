...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public void setNPicker(List<T> options3Items) {
        wheelOptions.setLinkage(false);
        wheelOptions.setNPicker(options3Items);
        reSetCurrentItems();
    }
...
*/
    ...
    public void returnData() {
        if(mPickerOptions.optionsSelectListener != null) {
            ...
            mPickerOptions.optionsSelectListener.onOptionsSelect( optionsCurrentItems[2] , clickView);
        }
    }
